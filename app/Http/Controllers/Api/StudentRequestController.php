...
class StudentRequestController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $requests->setCollection(
            $requests->getCollection()->map(function (StudentRequest $req) use ($categoryMap, $request) {
    ...
    {
        $req = StudentRequest::query()->findOrFail($id);
        $req->increment('views');
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $req = StudentRequest::query()->create($validated + [
