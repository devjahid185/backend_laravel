...
Route::middleware(['auth:sanctum', 'admin'])->group(function (): void {
    ...
    Route::post('/admin/ai-social/generate', [AdminAiSocialController::class, 'generate']);
    Route::put('/admin/ai-social/posts/{post}', [AdminAiSocialController::class, 'updatePost'])->whereNumber('post');
    Route::post('/admin/ai-social/posts/{post}/image', [AdminAiSocialController::class, 'generateImage'])->whereNumber('post');
    Route::post('/admin/ai-social/posts/{post}/approve', [AdminAiSocialController::class, 'approve'])->whereNumber('post');
    Route::post('/admin/ai-social/posts/{post}/publish', [AdminAiSocialController::class, 'publish'])->whereNumber('post');
    Route::post('/admin/ai-social/publish-due', [AdminAiSocialController::class, 'publishDue']);
    ...
    Route::prefix('food')->group(function (): void {
        ...
        Route::get('/owner/settlement', [FoodDeliveryController::class, 'ownerSettlement']);
        ...
        Route::get('/owner/coupons', [FoodDeliveryController::class, 'ownerCoupons']);
        Route::post('/owner/coupons', [FoodDeliveryController::class, 'saveOwnerCoupon']);
        Route::delete('/owner/coupons/{id}', [FoodDeliveryController::class, 'deleteOwnerCoupon'])->whereNumber('id');
        ...
        Route::post('/coupon-preview', [FoodDeliveryController::class, 'couponPreview']);
        ...
        Route::post('/orders/{id}/payment-proof', [FoodDeliveryController::class, 'updateOrderPaymentProof'])->whereNumber('id');
    ...
    Route::prefix('medicine')->group(function (): void {
        ...
        Route::post('/delivery-charge-preview', [MedicineDeliveryController::class, 'deliveryChargePreview']);
